...
from scenarioconfigs.scenario_configuration import ActorConfigurationData, ScenarioConfiguration, WeatherConfiguration
...
class OpenScenarioConfiguration(ScenarioConfiguration):
        ...
        for entity in xml_tree.iter("Entities"):
            for obj in entity.iter("Object"):
                for vehicle in obj.iter("Vehicle"):
                    ...
                    new_actor = ActorConfigurationData(model, lgsvl.Transform(), rolename)
    ...
    def _get_actor_transform(self, actor_name):
        ...
        actor_transform = lgsvl.Transform()
